<?php
include('config.php');
$newCarsCount = $_POST['newCarsCount'];
...
$sql = "SELECT * FROM car 
        ...
        JOIN office on office.office_id = car.FK_office_id LIMIT $newCarsCount";
...
?>
<?php 
if ($newCarsCount > $countCar) {
    $complete =  "<p>All cars have been loaded</p>";
}
?>
<script>
    $(function($) {
